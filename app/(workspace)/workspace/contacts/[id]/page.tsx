...
function ContactSkeleton() {
  return (
    <div className="animate-pulse flex flex-col gap-5">
      ...
      <div className="rounded-2xl bg-white p-8" style={{ border: '1px solid #f0f0f0' }}>
    ...
    <div className="p-6 max-w-4xl mx-auto flex flex-col gap-5">
      ...
      {contact && (
        ...
        >
          ...
          {/* Metadata */}
          <div
            className="bg-white rounded-2xl px-6 py-5 flex items-center gap-8"
            style={{ border: '1px solid #f0f0f0' }}
          >
            ...
            <div className="h-8 w-px" style={{ backgroundColor: '#f0f0f0' }} />
